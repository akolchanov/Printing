...
public class CustomOrdersAdapter extends ArrayAdapter<OrdersModel> implements View.OnClickListener{
    ...
    public CustomOrdersAdapter(ArrayList<OrdersModel> data, Context context) {
    ...
    public void onClick(View v) {
        ...
        {
            case R.id.item_info:
                Snackbar.make(v, "Статус заказа: " +dataModel.getStatus(), Snackbar.LENGTH_LONG)
